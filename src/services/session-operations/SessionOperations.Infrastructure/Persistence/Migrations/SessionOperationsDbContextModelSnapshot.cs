...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SessionOperations.Domain.LiveSessions.EvidenceSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SessionOperations.Domain.LiveSessions.LiveSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SessionOperations.Domain.LiveSessions.ReleasedHint", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("released_hints", "session_operations");
                });

            modelBuilder.Entity("SessionOperations.Domain.LiveSessions.SessionTeam", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SessionOperations.Domain.LiveSessions.SessionTeamProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SessionOperations.Domain.LiveSessions.TeamParticipation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SessionOperations.Domain.LiveSessions.ValidationOverrideLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SessionOperations.Domain.LiveSessions.EvidenceSubmission", b =>
                {
                    b.HasOne("SessionOperations.Domain.LiveSessions.LiveSession", null)
                        .WithMany("EvidenceSubmissions")
                        .HasForeignKey("LiveSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SessionOperations.Domain.LiveSessions.SessionTeam", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SessionOperations.Domain.LiveSessions.ValidationOverrideLog", b =>
                {
                    b.HasOne("SessionOperations.Domain.LiveSessions.EvidenceSubmission", null)
                        .WithMany()
