...
using MissionDesign.Application.Features.MissionStages.Commands.CreateMissionStage;
using MissionDesign.Application.Features.MissionStages.Queries.ListMissionStages;
using MissionDesign.Application.Features.Missions.Commands.ActivateMission;
using MissionDesign.Application.Features.Missions.Commands.CreateMission;
using MissionDesign.Application.Features.Missions.Commands.DeactivateMission;
using MissionDesign.Application.Features.Missions.Commands.UpdateMission;
using MissionDesign.Application.Features.Missions.Queries.GetMissionById;
using MissionDesign.Application.Features.Missions.Queries.ListMissions;
using Umbral.ServiceDefaults;

namespace MissionDesign.Api.Controllers;

[ApiController]
[Route("api/mission-design/missions")]
...
public sealed class MissionsController(ISender sender) : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Created($"api/mission-design/missions/{mission.Id}", mission);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Created($"api/mission-design/stages/{stage.Id}", stage);
    }
}
