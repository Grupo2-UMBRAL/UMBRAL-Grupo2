...
using MissionManagement.Application.Features.MissionStages.Commands.CreateMissionStageHint;
using MissionManagement.Application.Features.MissionStages.Commands.DeactivateMissionStage;
using MissionManagement.Application.Features.MissionStages.Queries.GetMissionStageById;
using Umbral.ServiceDefaults;

namespace MissionManagement.Api.Controllers;

[ApiController]
[Route("api/mission-management/stages")]
...
public sealed class MissionStagesController(ISender sender) : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Created($"api/mission-management/stages/{missionStageId}", hint);
    }
