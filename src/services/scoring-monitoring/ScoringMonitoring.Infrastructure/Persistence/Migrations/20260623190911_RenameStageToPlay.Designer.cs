...
namespace ScoringMonitoring.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260623190911_RenameStageToPlay")]
    partial class RenameStageToPlay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScoringMonitoring.Domain.Audit.SessionEventLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("session_event_logs", "scoring_monitoring");
                });
            ...
            modelBuilder.Entity("ScoringMonitoring.Domain.Scoreboards.ScoreEntry", b =>
                {
                    ...
                    b.HasIndex("LiveSessionId", "SessionTeamId", "PlayId")
                        .IsUnique()
            ...
            modelBuilder.Entity("ScoringMonitoring.Domain.Scoreboards.ScoreEntry", b =>
                {
                    b.HasOne("ScoringMonitoring.Domain.Scoreboards.Scoreboard", null)
